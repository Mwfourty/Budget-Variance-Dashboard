...
// Ambient fluid-simulation background. Sits absolutely behind the app's
// floating panels at low opacity — it should read as texture/atmosphere,
// never compete with the dashboard content in front of it.
...
`;
    ...
    // Respect reduced-motion preferences: render one still frame, no autoplay drift.
    const prefersReducedMotion = window.matchMedia?.('(prefers-reduced-motion: reduce)').matches;

    const webgl = new WebGLManager({
      $wrapper: container,
      autoDemo: autoDemo && !prefersReducedMotion,
      autoSpeed,
      autoIntensity,
      takeoverDuration,
      autoResumeDelay,
    ...
    takeoverDuration, autoResumeDelay, autoRampDuration, backgroundColor, lightMode
  ]);
